    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 sidebar p-0">
            ...
            <nav>
                ...
                <a href="kelolabuku.php" class="active"><i class="fas fa-book"></i> Kelola Buku</a>
        ...
        <div class="col-12 p-4 content-push-bottom">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Kelola Buku</h2>
                <a href="tambahbuku.php" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Buku</a>
            </div>
            <div class="card">
                <div class="card-body">
                        ...
                        <table class="table table-bordered align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="editbuku.php?id_buku=<?php echo $row['id_buku']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                        <a href="hapusbuku.php?id_buku=<?php echo $row['id_buku']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus buku ini?')"><i class="fas fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                            </tbody>
...
<nav class="bottom-navbar">
    <div class="container">
        <div class="row">
            ...
            <div class="col text-center">
                <a href="kelolabuku.php" class="nav-link active"><i class="fas fa-book d-block"></i> Buku</a>
            </div>
            <div class="col text-center">
