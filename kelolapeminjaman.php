    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 sidebar p-0">
            ...
            <nav>
                ...
                <a href="kelola_peminjaman.php" class="active"><i class="fas fa-hand-holding"></i> Peminjaman</a>
                        ...
                        <table class="table table-bordered align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Tombol aksi, misal konfirmasi pengembalian atau hapus -->
                                        <?php if($row['status'] == 'Dipinjam'): ?>
                                            <a href="konfirmasikembali.php?id_peminjaman=<?php echo $row['id_peminjaman']; ?>" class="btn btn-sm btn-success" onclick="return confirm('Konfirmasi buku sudah dikembalikan?')"><i class="fas fa-check"></i> Konfirmasi Kembali</a>
                                        <?php endif; ?>
                                        <a href="#" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus peminjaman ini?')"><i class="fas fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                            </tbody>
...
<nav class="bottom-navbar">
    <div class="container">
        <div class="row">
            ...
            <div class="col text-center">
                <a href="kelolapeminjaman.php" class="nav-link active"><i class="fas fa-hand-holding d-block"></i> Pinjam</a>
            </div>
            <div class="col text-center">
